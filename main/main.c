...
//static const uint8_t arrow_sequence[] = {10, 11, 12, 13}; // Arrow symbols index in the symbols array
...
void task(void *pvParameter)
{
    ...
    while (1)
    {
        ...
        {
            max7219_draw_image_8x8(&dev, i * 8, (uint8_t *)symbols + offs);
        }
